...
class BME680(BME680Data):
    ...
    def __init__(self, i2c_addr=I2C_ADDR_PRIMARY, i2c_device=None):
        ...
        if self.chip_id != CHIP_ID:
            print("self.chip_id: ", self.chip_id)
    ...
    def get_sensor_data(self):
        ...
        for attempt in range(10):
            print("FIELD0_ADDR: ", FIELD0_ADDR)
            status = self._get_regs(FIELD0_ADDR, 1)
            print("status: ",status)

            print("NEW_DATA_MSK: ",NEW_DATA_MSK)
            ...
            # print("GAS_INDEX_MSK: ",GAS_INDEX_MSK)
            self.data.gas_index = regs[0] & GAS_INDEX_MSK
            # print("self.data.gas_index: ",self.data.gas_index)
            self.data.meas_index = regs[1]
            # print("self.data.meas_index: ",self.data.meas_index)
            ...
            # print("adc_pres: ",adc_pres)
            # print("adc_temp: ",adc_temp)
            # print("adc_hum: ",adc_hum)
            # print("adc_gas_res: ",adc_gas_res)
